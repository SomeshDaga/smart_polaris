...
Launch the profile pipeline first i.e. roslaunch gem_performance_profiler profile_pipeline.launch
We launch this node separately so that the arguments are fed directly
"""
...
# Default no. of repeats of each scenario per signal
RUNS_PER_SIGNAL = 100
